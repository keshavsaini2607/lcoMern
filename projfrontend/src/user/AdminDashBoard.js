...
const AdminDashboard = () => {
    ...
    //isAuthenticated stores user in localStorage of browser so by user we can access all other stuff here
        ...
        return (
            <div className="card">
                ...
                <ul className="list-group">
                    ...
                    <li className="list-group-item">
                        <Link to="/admin/product" className="nav-link text-success">Manage Products</Link>
                    </li>
    ...
    return (
        ...
        description = "Manage all your products/orders here"
